package com.yalday.gateway.config;
...
public class JHipsterProperties {
    ...
    public static class Swagger {
        ...
        private String title = "YaldayGateway API";

        private String description = "YaldayGateway API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "YaldayGateway";
